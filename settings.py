...
ADMINS = (
    ('Mozilla events', 'admin@email.com'),
)
...
MEDIA_ROOT = '/var/lib/mozevents/public/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://eventos.mozilla-hispano.org/media/'
...
SECRET_KEY = '=o-%kf+lj#=znv0twy3axg6y!gv*e63)z882irn=cq^@&v6%9d'
...
TEMPLATE_DIRS = (
    ...
    "/var/lib/mozevents/templates",
    "/var/lib/mozevents/templates/events",
)
